...
class BenchmarkPlotter:
    ...
    def save_and_display(self, fig: plt.Figure):
        plt.savefig("aider/training_data_aider/assets/models-over-time.png")
        plt.savefig("aider/training_data_aider/assets/models-over-time.svg")
        imgcat(fig)
...
def main():
    ...
    models = plotter.load_data("aider/training_data_aider/_data/edit_leaderboard.yml")
    ...
    plotter.plot("aider/training_data_aider/_data/edit_leaderboard.yml")
