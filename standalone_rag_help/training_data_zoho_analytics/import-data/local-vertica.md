Importing from Vertica using Zoho Databridge
...
To import data from local Vertica database, it is mandatory to install Zoho Databridge. Refer to the previous question to know how to Install.
